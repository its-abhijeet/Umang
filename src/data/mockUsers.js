const generateAbhaIdFunc = require("./Necessaryfunctions");
const generateFingerprintKeyFunc = require("./Necessaryfunctions");
const generateOtpFunc = require("./Necessaryfunctions");
